...
function transformData(data: ISales[]): VendaDia[] {
  ...
  return (
    <ResponsiveContainer width='99%' height={400}>
      <LineChart data={transformedData}>
        ...
        <Tooltip />
        <Legend />
        <Line type='monotone' dataKey='pago' stroke='#3b8ff3' strokeWidth={3} />
        <Line
          type='monotone'
          dataKey='processando'
          stroke='#e0b50f'
          strokeWidth={3}
        />
        <Line type='monotone' dataKey='falha' stroke='#ccc' strokeWidth={3} />
      </LineChart>
    </ResponsiveContainer>
  );
};
